<template>
    <div class="experience">
        ...
        <h4 class="page-heading">Experience</h4>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">Senior Systems Analyst</h5>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">Senior Web Applications Engineer</h5>
                <small class="company">Interop Technologies</small>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">Database &amp; Systems Administrator</h5>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">JavaScript Frontend Developer</h5>
                <small class="company">Arthrex</small>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">Product Manager</h5>
                <small class="company">MICROS (Oracle)</small>
        ...
        <div class="job">
            ...
            <div class="position">
                <h5 class="title">UI Engineer</h5>
                <small class="company">INgage Networks (formally Neighborhood America)</small>
